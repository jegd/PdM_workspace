...
tick_t duracion_1=100;
tick_t duracion_2=500;
tick_t duracion_3=1000;
delay_t delay_1;
delay_t delay_2;
delay_t delay_3;
//Vector con leds
...
delayInit(&delay_2,duracion_2);
delayInit(&delay_3,duracion_3);
  ...
  while (1)
  {
	...
	if(!(delayRead(&delay_2)))
			{HAL_GPIO_TogglePin(GPIOB, led[1]);}
	if(!(delayRead(&delay_3)))
