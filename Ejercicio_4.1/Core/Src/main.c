...
delay_t ret_rebote;				 					//Delay que evita el rebote
uint16_t led[3] = {LD1_Pin,LD2_Pin,LD3_Pin};		//Vector con leds
...
debounceFSM_init(&estadoActual);		//Inicialización de nuestra MEF

  while (1)
  {
	  debounceFSM_update(&estadoActual);
  }
